...
Akun ini digunakan untuk membuat laporan kerusakan fasilitas sekolah, menentukan lokasi, tingkat urgensi (Rendah, Sedang, Tinggi), kategori kerusakan, melampirkan foto bukti, atau mengirim sinyal Lapor Darurat (*Fast-Track*).
...
- Data Petugas & Teknisi: `/admin/technicians` *(Fitur Tambah/Edit/Hapus Teknisi & Penugasan Kategori)*
